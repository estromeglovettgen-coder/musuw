    ...
    kbDetail: {
      steps: {
        ...
        upload: {
          ...
          desc: 'Добавьте здесь файл или веб-ссылку — Musuw автоматически обработает и проиндексирует источник.'
        },
        intro: {
  ...
  newUserGuide: {
    ...
    steps: {
      doneLite: {
        ...
        desc: 'Задайте один вопрос или добавьте один источник. Руководство можно снова открыть по значку вопроса рядом с вашим именем.'
      },
      agentsLite: {
