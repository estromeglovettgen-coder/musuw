export default {
  ...
  integrations: {
    ...
    claw: {
      title: 'Musuw Skill',
      subtitle: 'Импорт документов и гибридный поиск (вектор + ключевые слова) через REST API Musuw — загрузки, URL, Markdown и поиск.',
      ...
      ecosystemNote: 'Skill размещён на ClawHub. Полная документация API — на странице ClawHub.',
      installCta: 'Открыть ClawHub',
      installCtaHint: 'Установка Musuw Skill · откроется в новой вкладке',
    ...
    chrome: {
      ...
      subtitle: 'Для self-hosted Musuw: вопросы в боковой панели, клиппинг страниц и Markdown-заметки в базы знаний прямо при просмотре.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'В Musuw Desktop задайте фиксированный порт API (например 37841) в API-информации.'
        },
        api: {
    ...
    api: {
      ...
      capabilityManageModelsHint: 'Управление конфигурациями моделей, учётными данными, проверками подключения и данными Musuw Cloud.',
      ...
      hmacSecretDesc: 'Тот же secret, что в Musuw; только для подписи JWT на backend — не отправляйте его в заголовке запроса.',
  ...
  agentEditor: {
    ...
    agentType: {
      ...
      liteDescriptions: {
        ragQa: 'Поиск по фрагментам документов с опорой на источники. Подходит для баз документов без Wiki.'
      },
    ...
    desc: {
      ...
      memoryEnabled: 'Разрешить этому агенту читать и пополнять вашу долговременную память. При выключении разговоры с ним не читают ваши записи и не добавляют новые. Если долговременная память выключена в настройках, включение здесь не подействует',
  ...
  kbSettings: {
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Musuw Cloud',
          desc: 'Парсинг документов через Musuw Cloud'
        },
        paddleocr_vl_cloud: {
  ...
  modelSettings: {
    ...
    sceneModels: {
      ...
      scenes: {
        chat: { label: 'Chat', description: 'Внутренний диалог платформенного агента.' },
        rag: { label: 'Модель агента', description: 'Формирует итоговый ответ на основе результатов поиска по базе знаний, Wiki или в интернете.' },
        rerank: { label: 'Rerank', description: 'Повторное ранжирование результатов поиска.' },
        wiki: { label: 'Wiki', description: 'Синтез содержимого Wiki.' },
        vision: { label: 'Зрение', description: 'Понимание изображений и документов.' },
        asr: { label: 'Речь', description: 'Преобразование аудио в текст.' }
      }
    },
    copySuffix: ' копия',
  ...
  mcpSettings: {
    ...
    enableHint: 'Нажмите, чтобы включить сервис',
    disableHint: 'Нажмите, чтобы выключить сервис',
  ...
  theme: {
    ...
    color: 'Цвет бренда',
    colorDescription: 'Выберите цвет бренда отдельно от светлой или тёмной темы',
    musuw: 'Синий Musuw',
    weknora: 'Зелёный WeKnora',
    selectColor: 'Выбрать цвет бренда'
  },
  general: {
    ...
    noMatchingSettings: 'Подходящие настройки не найдены',
  ...
  entitlement: {
    ...
    active: 'активен',
    storage: 'Хранилище',
    monthlyCredits: 'Месячный лимит ИИ',
    knowledgeBases: 'Базы знаний',
    documentsPerKb: 'Документов в базе знаний',
    ...
    freeUrlImport: 'Импорт по ссылке доступен на платных тарифах.',
    storageQuotaUpgradeBody: 'Хранилище заполнено. Перейдите на платный тариф, чтобы продолжить загрузку файлов.',
    upgradeRequiredTitle: 'Обновите тариф, чтобы продолжить',
    notNow: 'Не сейчас',
    urlImportUpgradeBody: 'Импорт веб-страниц и видео из соцсетей доступен на платных тарифах. Введённая ссылка сохранена.',
    videoUploadUpgradeBody: 'Загрузка видео доступна на платных тарифах. Обновите тариф, чтобы продолжить.',
    videoMixedUpgradeBody: 'Обычные файлы ({allowed}) продолжают загружаться. Для загрузки видео ({blocked}) обновите тариф.',
    advancedModelUpgradeBody: 'Эта расширенная модель доступна на платных тарифах. Обновите тариф, чтобы выбрать её.',
    renewsMonthly: 'Период кредитов {month} (UTC)',
    billingUnavailable: 'Обновление недоступно, пока оплата не настроена.',
    choosePlan: 'Выберите план',
    monthly: 'Ежемесячно',
    yearly: 'Ежегодно',
    continueToCheckout: 'Перейти к безопасной оплате',
    checkoutSecureNote: 'Безопасная страница оплаты показывает итоговую региональную цену, налоги и способы оплаты. План меняется только после подтверждения платежа.',
    checkoutCompleted: 'Оплата завершена. План синхронизируется.',
    checkoutFailed: 'Не удалось открыть безопасную страницу оплаты. Повторите попытку.',
    billingManaged: 'Платежи и подписки безопасно управляются платежной системой.',
    manageBilling: 'Управлять платежами',
    portalFailed: 'Не удалось открыть платежный портал. Повторите попытку.',
    plans: { free: 'Free', plus: 'Plus', pro: 'Pro', max: 'Max' },
    pricingTitle: 'Обновите свой план',
    pricingDescription: 'Начните бесплатно и обновитесь в любой момент. Цены и способы оплаты адаптируются к региону.',
    planDescriptions: { free: 'Попробуйте полный персональный процесс работы со знаниями.', plus: 'Для регулярных личных исследований и ответов.', pro: 'Больше лимита для частой работы со знаниями.', max: 'Максимальный текущий лимит для интенсивной работы.' },
    allowanceLevels: { free: 'Базовый', plus: 'Повышенный', pro: 'Расширенный', max: 'Максимальный' },
    freePrice: 'Бесплатно',
    perMonth: '/ месяц',
    perYear: '/ год',
    recommended: 'Рекомендуем',
    includes: 'Включает',
    currentPlanAction: 'Текущий план',
    includedInCurrent: 'Включено в ваш план',
    choosePlanAction: 'Выбрать {plan}',
    featureStorage: '{amount} ГБ хранилища',
    featureAllowance: '{level} лимит ИИ',
    featureFreeKnowledge: '1 база знаний, до 10 документов',
    featureBudgetModel: 'Подобранные модели Free',
    featureUnlimitedKnowledge: 'Нет лимита плана на базы знаний и документы',
    featureAllModels: 'Все доступные модели',
    featureVideo: 'Загрузка и анализ видео',
    usageTitle: 'Использование и оплата',
    usageDescription: 'Просматривайте план, остаток лимита и ограничения аккаунта.',
    usageLimits: 'Лимиты использования',
    planLimits: 'Возможности плана',
    usageMenu: 'Использование',
    account: 'Аккаунт',
    ...
    videoAccess: 'Доступ к видео',
    included: 'Включено',
    notIncluded: 'Не включено',
    choosePeriod: 'Выберите период оплаты',
    upgradePlan: 'Повысить план',
    upgradeDescription: 'Выберите план и период оплаты, чтобы продолжить.',
    upgradePaidDescription: 'Период оплаты не меняется; платёжная система рассчитает сумму пропорционально оставшемуся сроку.',
    upgradeTo: 'Перейти на {plan}',
    upgradeConfirmTitle: 'Перейти на {plan}',
    upgradeConfirmBody: 'Сумма изменения: {amount}. После подтверждения она будет списана с текущего способа оплаты, затем план и лимит обновятся автоматически.',
    upgradeConfirm: 'Подтвердить переход',
    upgradePending: 'Переход отправлен. План и лимит синхронизируются.',
    upgradeFailed: 'Не удалось повысить план. Повторите попытку.',
    managePlan: 'Управление планом',
    manageDescription: 'Измените или отмените текущую подписку.',
    billingAdminOnly: 'Начинать и управлять оплатой могут только владельцы и администраторы рабочего пространства.',
    billingNotConfigured: 'Изменение плана сейчас недоступно.',
    billingRenewalPending: 'Подтверждение оплаты ещё не завершено или требует восстановления. Доступ к ИИ восстановится после синхронизации оплаты.',
    billingPendingShort: 'Ожидается подтверждение оплаты',
    checkoutUnavailable: 'Этот план сейчас недоступен. Повторите попытку позже.',
    portalUnavailable: 'Управление планом сейчас недоступно. Повторите попытку позже.',
    usageUnavailable: 'Сведения об использовании сейчас недоступны.',
    viewPlans: 'Посмотреть планы',
    backToProduct: 'Вернуться в Musuw',
    backToPlans: 'Назад к планам',
    checkoutTitle: 'Настройка плана',
    quickPayment: 'Быстрая оплата',
    secureCheckoutLoading: 'Выберите безопасный способ оплаты Paddle для оформления подписки.',
    checkoutLoadFailed: 'Не удалось загрузить оплату. Вернитесь к планам и повторите попытку.',
    checkoutPaymentFailed: 'Платёж не завершён. Проверьте платёжные данные и повторите попытку ниже. Тариф и лимит не изменились.',
    ...
    checkoutSyncDelayedTitle: 'Платёж получен, права ещё синхронизируются',
    checkoutSyncDelayedDescription: 'Можно безопасно вернуться в Musuw или обновить статус.',
    refreshStatus: 'Обновить статус',
    returnToProduct: 'Вернуться в Musuw',
    paymentLinkTitle: 'Безопасная оплата Paddle',
    paymentLinkReady: 'Используйте ссылку на оплату из квитанции или письма Paddle. Безопасная форма оплаты откроется на этой странице автоматически.',
    paymentLinkError: 'Страница безопасной оплаты недоступна. Вернитесь в musuw или обратитесь в поддержку.',
    paymentLinkSupport: 'Связаться с поддержкой',
    paymentLinkLegal: 'Информация об оплате и правовые документы',
  ...
  system: {
    ...
    versionDescription: 'Версия сервиса приложения Musuw',
    frontendVersionLabel: 'Версия UI',
    frontendVersionDescription: 'Версия сборки Musuw UI',
    ...
    globalSettings: {
      ...
      keyDescriptions: {
        ...
        tenant: {
          ...
          default_storage_quota_gb: 'Квота хранилища по умолчанию (ГБ) для нового пространства: векторы, оригиналы, текст, индексы и т.д. Читается только при создании — изменения применяются только к новым пространствам и не перезаписывают существующие. 0 или отрицательное значение — встроенное значение по умолчанию 1 ГБ.',
      ...
      sections: {
        ...
        models: {
          ...
          description: 'Настройте бесплатные модели по умолчанию и упорядоченные платные варианты для агента, Rerank, Wiki, зрения и речи.'
        }
      },
      models: {
  ...
  chat: {
    ...
    aiCreditsExhausted: 'Месячный лимит ИИ исчерпан. Обновите тариф сейчас или дождитесь следующего обновления.',
    billingRenewalPending: 'Подтверждение оплаты ещё не завершено или требует восстановления.',
  ...
  knowledgeEditor: {
    ...
    titleEdit: 'Изменить настройки базы знаний',
    modalDescription: 'Настройте обработку, стратегию индексирования и параметры извлечения',
    advanced: {
    ...
    wikiBrowser: {
      ...
      graphStyleToggle: 'Переключить стиль графа',
      graphVisualStyle: 'Визуальный стиль',
      graphStyles: {
        obsidianExact: { name: 'Полный Obsidian', desc: 'Оригинальные WASM-силы, холст Pixi и все настройки' },
        weknoraNative: { name: 'Нативный WeKnora', desc: 'Оригинальный SVG-граф, силовая раскладка и взаимодействия из репозитория' },
        threeNebula: { name: 'Туманность Obsidian 3D', desc: 'Настоящая 3D-сфера, свечение и автовращение' },
        sigmaNebula: { name: 'Живая туманность', desc: '3D-вращение и пульсирующие кластеры' },
        sigmaForce: { name: 'Гравитация', desc: 'Поле связей ForceAtlas' },
        sigmaCircle: { name: 'Классический круг', desc: 'Официальная круговая схема Graphology' },
        sigmaOrbit: { name: 'Орбиты', desc: 'Многоуровневое распределение' },
        sigmaClusters: { name: 'Сообщества', desc: 'Кластеры по типу страницы' },
        g6Obsidian: { name: 'G6 Obsidian', desc: 'Силы Graph View в рендерере G6' },
        g6Force: { name: 'Силовое поле', desc: 'Естественное раскрытие связей' },
        g6ForceAtlas2: { name: 'Гравитация сообществ', desc: 'Встроенный ForceAtlas2 в G6' },
        g6Fruchterman: { name: 'Поле кластеров', desc: 'Встроенная кластерная силовая схема' },
        g6Mds: { name: 'Карта MDS', desc: 'Встроенная карта расстояний связей' },
        g6Radial: { name: 'Радиальная', desc: 'Расходится от центрального узла' },
        g6Concentric: { name: 'Концентрическая', desc: 'Связанные узлы ближе к центру' },
        g6Circular: { name: 'Звёздные треки', desc: 'Спиральное распределение' },
        g6Grid: { name: 'Матрица', desc: 'Регулярная сетка обзора' },
      },
      obsidianGraph: {
        filters: 'Фильтры',
        search: 'Поиск',
        ...
        existingOnly: 'Только существующие файлы',
        orphans: 'Изолированные узлы',
        groups: 'Группы',
        groupQuery: 'Запрос группы',
        ...
        linkThickness: 'Толщина связи',
        animate: 'Запустить анимацию',
        playbackTitle: 'Воспроизведение роста',
        playbackDescription: 'Показывать граф постепенно по шкале времени, настроенной по Obsidian.',
        playbackPlay: 'Запустить анимацию роста',
        playbackPause: 'Приостановить анимацию роста',
        playbackResume: 'Продолжить анимацию роста',
        playbackReplay: 'Повторить анимацию роста',
        playbackRestore: 'Вернуть исходный вид',
        playbackProgress: '{visible} / {total} узлов',
        forces: 'Силы',
        center: 'Сила центра',
        repel: 'Сила отталкивания',
        link: 'Сила связи',
        linkDistance: 'Длина связи',
        reset: 'Восстановить значения',
        settings: 'Настройки графа',
        open: 'Открыть настройки графа',
        close: 'Закрыть настройки графа',
        switchStyle: 'Сменить стиль графа',
        closeStylePicker: 'Закрыть выбор стиля',
      },
      graphStyleSwitchFailed: 'Не удалось переключить стиль графа. Предыдущий стиль восстановлен.',
    ...
    basic: {
      ...
      defaultName: 'Моя база знаний',
      defaultNameWithIndex: '{name} ({index})',
      descriptionLabel: 'Описание базы знаний (необязательно)',
  ...
  knowledgeList: {
    ...
    liteSubtitle: 'Управляйте базами документов: загружайте материалы и начинайте поиск и ответы',
    favorites: {
    ...
    empty: {
      ...
      description: 'Нажмите «Создать базу знаний» на странице, чтобы добавить первую базу.',
  ...
  createChat: {
    title: 'Привет, я Musuw — ваши знания всегда под рукой',
  ...
  input: {
    ...
    back: 'Назад',
    noReasoningEfforts: 'Нет доступных уровней рассуждений',
    searchModels: 'Поиск моделей',
    clearModelSearch: 'Очистить поиск моделей',
    reasoningDescriptions: {
      none: 'Быстрее для повседневных вопросов',
      minimal: 'Лёгкое рассуждение и быстрый ответ',
      low: 'Баланс скорости и рассуждения',
      medium: 'Стандартное рассуждение для сложных задач',
      high: 'Более глубокий многошаговый анализ',
      xhigh: 'Расширенное рассуждение для трудных задач',
      max: 'Максимальная глубина, требуется больше времени'
    },
  ...
  auth: {
    ...
    registerSubtitle: 'Создайте аккаунт и начните работу с Musuw',
    ...
    workspaceOnboarding: {
      liteTitle: 'Подготавливаем ваш Musuw',
      liteDescription: 'У каждой учётной записи одно личное пространство — создавать или присоединяться к рабочей области не нужно.',
      liteLoading: 'Подготавливаем личное пространство…',
      liteLoadFailed: 'Не удалось подготовить личное пространство. Проверьте подключение и повторите попытку.',
      liteWaiting: 'Личное пространство ещё готовится. Повторите проверку через несколько секунд.',
  ...
  memorySettings: {
    ...
    workspaceDisabled: 'Долговременная память пока не включена. Этот переключатель начнёт действовать после её включения.',
    ...
    archivedHint: 'Архивные записи в разговор не попадают. Когда превышен лимит памяти, реже используемые пункты убираются автоматически.',
  ...
  memoryWorkspaceSettings: {
    ...
    description: 'Позволяет ассистенту помнить между разговорами личные сведения, предпочтения, устойчивые факты и текущие задачи.',
    loadError: 'Не удалось загрузить настройки долговременной памяти. Повторите попытку.',
    introTitle: 'По умолчанию выключена, включать нужно вручную',
    introDescription: 'Долговременная память сохраняет сказанное в разговорах, поэтому она не включается сама. После включения её можно просматривать, изменять, удалять или полностью отключить в разделе «Моя память». Активные сведения о вас и предпочтения включаются в каждый следующий ход; факты и текущие задачи вспоминаются, только если вопрос с ними связан.',
    enableLabel: 'Включить долговременную память',
    enableDescription: 'При выключении разговоры не читают и не записывают память.',
    ...
    writeModeExplicitHint: 'Сохраняется только то, что было явно предложено запомнить, и записи, добавленные вручную. Дополнительных вызовов модели нет.',
    writeModeAutoHint: 'Дополнительно после разговора один раз вызывается модель, чтобы выделить то, что стоит сохранить надолго.',
    advancedLabel: 'Расширенные настройки',
    advancedDescription: 'Модели, семантический поиск и параметры автоматического извлечения. Обычно достаточно значений по умолчанию.',
    autoOnlyHint: 'Переключитесь на «Извлекать автоматически», чтобы настроить этот параметр.',
    vectorOnlyHint: 'Включите «Поиск памяти по смыслу», чтобы выбрать эту модель.',
    ...
    extractMinIntervalDescription: 'Минимальный интервал между двумя извлечениями ограничивает расходы. Сообщения, появившиеся внутри интервала, не теряются — они переносятся на следующий запуск.',
    ...
    instructionsDescription: 'Пользовательские правила, добавляемые к промпту извлечения, для политик, которые продукт не может угадать — например «никогда не записывать имена клиентов».',
    instructionsPlaceholder: 'По одному правилу в строке, например: не записывать имена клиентов',
    maxItemsLabel: 'Лимит памяти',
  ...
  settings: {
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'напр. musuw/images',
      prefixPlaceholder: 'напр. musuw',
    ...
    weknoraCloud: {
      title: 'Musuw Cloud',
      description: 'Настройте учётные данные APPID и APPSECRET для Musuw Cloud. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные Musuw Cloud истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения Musuw Cloud',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения Musuw Cloud',
      ...
      modelsSection: {
        ...
        descReady: 'Зарегистрируйте четыре стандартные модели Musuw Cloud для чата, поиска, реранкинга и зрения.',
  ...
  agent: {
    ...
    editor: {
      ...
      postCreateHint: {
        ...
        footerLite: 'Продолжите настройку, затем нажмите «Сохранить и закрыть».',
      ...
      promptsConfigDesc: 'Настройка системного промпта агента',
      ...
      knowledgeConfigDescLite: 'Настройте, к каким базам документов агент может обращаться',
  ...
  uploadConfirm: {
    ...
    videoCapability: 'Разбор видео, до 300 МБ',
    videoTooLarge: 'Видео более 300 МБ не поддерживаются в этой версии',
    videoUploadFailed: 'Не удалось загрузить видео. Повторите попытку позже.',
    videoFormatUnsupported: 'Этот формат видео не поддерживается',
    urlItemLabel: 'URL',
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      deleteConfirm: "Удалить папку «{name}» и все документы в её подпапках? Отменить это действие нельзя.",
      deleteSubmitted: "Отправлен запрос на удаление {count} документов",
      deletePartial: "Запрос на удаление {count} документов отправлен; для {remaining} документов подтверждение не получено. Обновите страницу перед повторной попыткой.",
      deleteFailed: "Не удалось завершить удаление папки. Обновите страницу и повторите попытку.",
      loadDocumentsFailed: "Не удалось загрузить документы",

      countTooltip: 'В этой папке: {direct} документов; включая вложенные папки: {total}',
      title: 'Папки',
      rootRow: 'Корень',
    ...
    uploadProgress: {
      title: 'Ход загрузки',
      summary: 'Всего {total} · Отправлено {uploaded} · Ошибок {failed} · Осталось {remaining}',
      current: 'Загрузка: {name} ({progress}%)',
      keepOpen: 'Не закрывайте страницу. Статус обработки отправленных документов обновляется автоматически.',
      finished: 'Загрузка завершена. Статус обработки обновляется автоматически. Проверьте причины ошибок перед повторной загрузкой.',
      details: 'Сведения о файлах',
      waiting: 'Ожидание загрузки',
      uploading: 'Загрузка',
      success: 'Отправлено на обработку',
    ...
    importURLTitle: 'Импорт URL или текста из публикации',
    urlRequired: 'Введите URL или текст из публикации',
    ...
    urlLabel: 'URL или текст публикации',
    urlPlaceholder: 'Вставьте URL или текст публикации с платформы',
    urlSupportedPlatforms: 'Поддерживаются',
    urlClear: 'Очистить',
    urlTooLong: 'URL или текст публикации не должен превышать 4 КБ',
    ...
    batchCancelParseConfirm: 'Остановить разбор выбранных активных документов ({count})? Завершённые документы не изменятся.',
    batchCancelParseSuccess: 'Отправлен запрос на остановку разбора документов: {count}',
    batchCancelParsePartial: 'Запрос на остановку отправлен для {success}; ошибок: {failed}, можно повторить',
    draft: 'Черновик',
  ...
  contextualGuide: {
    ...
    chat: {
      steps: {
        picker: {
          title: 'Выберите способ ответа',
          desc: 'Здесь выбираются агент, модель и глубина рассуждения. Для некоторых продвинутых моделей нужен другой тариф — перед использованием появится понятная подсказка.'
        },
        done: {
    ...
    kbDetail: {
      steps: {
        rag: {
          title: 'RAG: сначала поиск, затем ответ',
          desc: 'RAG разбивает материалы на фрагменты и создаёт векторный и ключевой индексы. Musuw сначала находит исходные фрагменты, затем отвечает с опорой на них и указывает источники.'
        },
        wiki: {
          title: 'Wiki: превращает материалы в знания',
          desc: 'Wiki извлекает из источников людей, продукты и понятия, затем создаёт связанные страницы со ссылками на источники и граф.'
        },
        uploadFile: {
          title: 'Добавить документ',
          desc: 'Загрузите или перетащите поддерживаемый файл. Musuw автоматически обработает и проиндексирует его.'
        },
        uploadUrl: {
          title: 'Импорт из веба и соцсетей',
          desc: 'Импортируйте здесь публичные веб-страницы, публикации с изображениями и видео. После обработки они доступны в чате с цитатами, Wiki и графе.'
        }
      }
    },
    agentCreate: {
      steps: {
        submitLite: {
          ...
          desc: 'Проверьте имя, модель и область знаний, затем нажмите выделенную кнопку «Создать».'
        },
        knowledgeLite: {
          title: 'Выберите знания',
          desc: 'Используйте все свои базы знаний, выберите конкретные или пока не подключайте знания.'
        },
        modelLite: {
          title: 'Выберите модель',
          desc: 'Выберите модель, доступную в вашем тарифе. Для заблокированных продвинутых моделей будет явно предложено обновление.'
        },
        nameLite: {
          title: 'Назовите агента',
          desc: 'Укажите понятное имя. Описание можно добавить или уточнить позже.'
        },
        modeLite: {
          title: 'Выберите способ ответа',
          desc: 'Быстрый ответ подходит для прямых вопросов, а умное рассуждение — для сложных многошаговых задач.'
        },
        submit: {
    ...
    kbCreate: {
      steps: {
        nameLite: {
          title: 'Проверьте название базы',
          desc: 'Название уже заполнено: оставьте его или замените на более понятное.'
        },
        submitLite: {
          title: 'Создать базу знаний',
          desc: 'Нажмите выделенную кнопку «Создать». На следующей странице можно добавить первый материал.'
        },
        submit: {
          title: 'Создать базу знаний',
    ...
    kbList: {
      steps: {
        ...
        createLite: {
          title: 'Создайте первую базу знаний',
          desc: 'Базы знаний помогают хранить и организовывать документы. Нажмите выделенную кнопку «Новая база знаний» ниже — мы проведём вас по форме.'
        }
      }
    }
  },
  newUserGuide: {
    ...
    steps: {
      doneLite: {
        ...
        desc: 'Задайте один вопрос или добавьте один источник. На следующих страницах подсказки появятся именно там, где они понадобятся.'
      },
      agentsLite: {
        title: 'Выберите подходящего агента',
        desc: 'Быстрый ответ подходит для обычных вопросов, умное рассуждение — для сложных задач. При необходимости создайте собственного агента.'
      },
      settingsLite: {
        title: 'Аккаунт и настройки',
        desc: 'В этом меню можно посмотреть аккаунт, использование и настройки внешнего вида.'
      },
      chatLite: {
        title: 'Начните с диалога',
        desc: 'Задайте вопрос или добавьте изображение либо файл. Musuw ясно сообщит, когда для продвинутой модели или платной функции нужен другой тариф.'
      },
      welcomeLite: {
        title: 'Добро пожаловать в Musuw',
        desc: 'Ваше личное пространство и доступные модели уже готовы. Настройка не требуется — покажем три основных раздела.'
      },
      done: {
        title: 'Всё готово',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и Musuw автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.'
      },
      knowledgeLite: {
        title: 'Создайте базу знаний',
        desc: 'С этого всё начинается: загружайте документы и веб-страницы, а Musuw автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.'
      },
      welcome: {
        title: 'Добро пожаловать в Musuw',
