export default {
  ...
  entitlement: {
    ...
    recoveryPlanAction: 'Восстановить с {plan}',
    ...
    recoveryCheckoutNotice: 'Предыдущую подписку Paddle не удалось подтвердить. Выберите текущий или более высокий план, чтобы безопасно восстановить оплату.',
    ...
    recoveryCheckoutTitle: 'Восстановить оплату через Paddle',
    recoveryCheckoutDescription: 'Предыдущую платёжную привязку не удалось подтвердить. Восстановите план через безопасную оплату Paddle; доступ изменится только после проверки подписанных платёжных событий.',
