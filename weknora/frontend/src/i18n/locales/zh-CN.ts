export default {
  ...
  entitlement: {
    ...
    recoveryCheckoutNotice: '无法验证此前的 Paddle 订阅。请选择当前或更高套餐，通过安全结账恢复支付绑定。',
    ...
    recoveryCheckoutTitle: '通过 Paddle 恢复支付绑定',
    recoveryCheckoutDescription: '无法验证此前的支付绑定。请通过 Paddle 安全结账恢复套餐；只有验证签名支付事件后才会更新访问权限。',
