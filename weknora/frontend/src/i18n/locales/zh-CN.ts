import { creatorMarketplaceZh } from '../creatorMarketplace'
export default {
  creatorMarketplace: creatorMarketplaceZh,
  platformApiKeys: {
    title: '平台 API Key',
  ...
  integrations: {
    ...
    claw: {
      title: 'Musuw Skill',
      subtitle: '通过 Musuw REST API 导入文档并执行混合检索（向量 + 关键词）。适用于上传文件/URL/Markdown 到知识库、跨库检索与浏览知识内容。',
      ...
      ecosystemNote: 'Skill 托管于 ClawHub，完整 API 说明与版本历史请参见 ClawHub 页面。',
      installCta: '前往 ClawHub',
      installCtaHint: '安装 Musuw Skill · 将在新标签页打开',
    ...
    chrome: {
      title: '知识管理助手',
      subtitle: '配合 Musuw 自建服务使用：在任意网页侧边栏提问、剪藏内容、Markdown 速记，将浏览中的知识沉淀到你的知识库。',
      ...
      steps: {
        ...
        port: {
          title: '桌面版配置固定端口（推荐）',
          desc: '使用 Musuw 桌面版时，在 API 信息中设置固定端口（如 37841），避免每次启动后地址变化导致插件断连。'
        },
        api: {
          title: '获取 API 凭证',
          desc: '在「设置 → API 信息」中复制 API Key 与 API 地址。'
    ...
    api: {
      ...
      capabilityManageModelsHint: '允许管理模型配置、模型凭据、模型连通性测试和 Musuw Cloud 凭据。',
      ...
      signedFlowDetail: 'HMAC 密钥仅保存在 Musuw 与你的可信后端，切勿放入请求或下发给浏览器。请求头里传的是用该密钥签出的 JWT 字符串（每次签发或过期后会变），不是密钥本身。JWT 须包含 sub（外部用户 ID）、tenant_id、aud=weknora、exp（有效期不超过 24 小时）。',
      ...
      hmacSecret: 'HMAC 密钥',
      hmacSecretDesc: '与 Musuw 保存的同一份密钥；仅用于后端签发 JWT，不要作为请求头发送。',
  ...
  entitlement: {
    ...
    freeUrlImport: '链接导入仅对付费方案开放。',
    storageQuotaUpgradeBody: '存储空间已用尽。升级套餐后可继续上传文件。',
    upgradeRequiredTitle: '升级套餐以继续',
    notNow: '暂不升级',
    urlImportUpgradeBody: '链接导入（包括网页和社媒视频）仅对付费套餐开放。你填写的链接已保留。',
    videoUploadUpgradeBody: '视频上传仅对付费套餐开放。升级后即可继续上传。',
    videoMixedUpgradeBody: '已继续上传 {allowed} 个普通文件；另外 {blocked} 个视频需要升级套餐后上传。',
    advancedModelUpgradeBody: '该高级模型仅对付费套餐开放。升级后即可选择。',
    renewsMonthly: '额度周期 {month}（UTC）',
    billingUnavailable: '计费尚未配置，暂时无法升级。',
    choosePlan: '选择方案',
    monthly: '月付',
    yearly: '年付',
    continueToCheckout: '前往安全结账',
    checkoutSecureNote: '安全支付页会根据所在地区显示最终价格、税费和可用支付方式；支付确认后套餐才会生效。',
    checkoutCompleted: '支付已完成，正在同步套餐。',
    checkoutFailed: '暂时无法打开安全支付页，请重试。',
    billingManaged: '账单与订阅由支付系统安全管理。',
    ...
    planDescriptions: { free: '体验完整知识闭环', plus: '适合增长中的知识库', pro: '适合日常知识工作', max: '适合高强度知识工作' },
    ...
    recommended: '推荐',
    includes: '套餐包含',
    currentPlanAction: '当前套餐',
    includedInCurrent: '已包含在当前套餐',
    choosePlanAction: '选择 {plan}',
    featureStorage: '{amount} GiB 存储空间',
    featureAllowance: '{level} 每月 AI 额度',
    featureFreeKnowledge: '1 个知识库（10 篇文档）',
    featureBudgetModel: '标准模型',
    featureUnlimitedKnowledge: '不限知识库与文档数',
    featureAllModels: '高级模型',
    featureVideo: '视频与多平台导入',
    usageTitle: '使用情况与计费',
    ...
    choosePeriod: '选择计费周期',
    upgradePlan: '升级套餐',
    upgradeDescription: '选择套餐和计费周期后继续。',
    upgradePaidDescription: '升级沿用当前计费周期，变更金额由支付系统按剩余周期计算。',
    upgradeTo: '升级到 {plan}',
    upgradeConfirmTitle: '升级到 {plan}',
    upgradeConfirmBody: '本次变更金额为 {amount}。确认后将通过现有支付方式结算，并在支付确认后自动更新套餐和额度。',
    upgradeConfirm: '确认升级',
    upgradePending: '升级已提交，正在同步套餐和额度。',
    ...
    checkoutUnavailable: '该套餐当前不可用，请稍后重试。',
    portalUnavailable: '当前暂时无法管理套餐，请稍后重试。',
    usageUnavailable: '暂时无法获取使用情况。',
    viewPlans: '查看套餐',
    backToProduct: '返回 Musuw',
    backToPlans: '返回套餐',
    checkoutTitle: '配置套餐',
    quickPayment: '快捷支付',
    ...
    checkoutSyncDelayedTitle: '付款已收到，权益仍在同步',
    checkoutSyncDelayedDescription: '您可以安全返回 Musuw，或刷新状态继续确认。',
    refreshStatus: '刷新状态',
    returnToProduct: '返回 Musuw',
    paymentLinkTitle: 'Paddle 安全支付',
    paymentLinkReady: '请使用 Paddle 收据或邮件中的支付链接，安全结账会在本页自动打开。',
    paymentLinkError: '安全支付页暂时不可用，请返回 musuw 或联系支持。',
    paymentLinkSupport: '联系支持',
    paymentLinkLegal: '支付与法律信息',
    termsOfService: '服务条款',
    privacyPolicy: '隐私政策',
    refundPolicy: '退款政策',
    planSuffix: '套餐',
  ...
  system: {
    ...
    retry: '重试',
    versionLabel: '应用版本',
    versionDescription: '当前 Musuw 应用服务的版本号',
    frontendVersionLabel: 'UI 版本',
    frontendVersionDescription: '当前 Musuw UI 界面的构建版本号',
  ...
  chat: {
    ...
    aiCreditsExhausted: '本月 AI 额度已用尽。升级套餐可立即获得更多额度，或等待下个周期刷新。',
    billingRenewalPending: '账单确认尚未完成或需要修复。',
    sessionExcerpt: '会话摘录',
  ...
  knowledgeEditor: {
    titleCreate: '新建知识库',
    titleEdit: '编辑知识库配置',
    modalDescription: '配置知识库的处理管道、索引策略与提取参数',
    advanced: {
      title: '高级设置',
    ...
    wikiBrowser: {
      ...
      graphStyleToggle: '切换图谱风格',
      graphVisualStyle: '视觉风格',
      graphStyles: {
        obsidianExact: { name: 'Obsidian 完整原生', desc: '原版 WASM 力场、Pixi 画布与完整设置' },
        weknoraNative: { name: 'WeKnora 原生', desc: '仓库原版 SVG 图谱、原版力场与原版交互' },
        threeNebula: { name: 'Obsidian 3D 星云', desc: '真实 3D 球壳、辉光与自动环绕' },
        sigmaNebula: { name: '动态星云', desc: '3D 旋转与呼吸星团' },
        sigmaForce: { name: '引力场', desc: 'ForceAtlas 关系聚合' },
        sigmaCircle: { name: '经典圆环', desc: 'Graphology 官方圆形布局' },
        sigmaOrbit: { name: '星系轨道', desc: '多层轨道分布' },
        sigmaClusters: { name: '社群星团', desc: '按页面类型聚类' },
        g6Obsidian: { name: 'G6 Obsidian', desc: 'G6 复刻的 Graph View 力场' },
        g6Force: { name: '力导向', desc: '关系自然展开' },
        g6ForceAtlas2: { name: '社群引力', desc: 'G6 内置 ForceAtlas2' },
        g6Fruchterman: { name: '簇群力场', desc: 'G6 内置聚类力导向' },
        g6Mds: { name: '关系降维', desc: 'G6 内置 MDS 距离映射' },
        g6Radial: { name: '径向辐射', desc: '从核心向外延伸' },
        g6Concentric: { name: '同心层级', desc: '高连接节点居中' },
        g6Circular: { name: '环形星轨', desc: '螺旋分层排列' },
        g6Grid: { name: '矩阵星图', desc: '规则网格总览' },
      },
      obsidianGraph: {
        filters: '筛选',
        search: '搜索',
        ...
        linkThickness: '连线粗细',
        animate: '重新动画',
        playbackTitle: '关系图谱播放',
        playbackDescription: '按 Obsidian 校准的时间线逐步显示图谱节点。',
        playbackPlay: '播放生长动画',
        playbackPause: '暂停生长动画',
        playbackResume: '继续生长动画',
        playbackReplay: '重新播放生长动画',
        playbackRestore: '恢复原样',
        playbackProgress: '{visible} / {total} 个节点',
        forces: '力场',
        center: '中心力',
        repel: '排斥力',
        link: '链接力',
        ...
        close: '关闭图谱设置',
        switchStyle: '切换图谱风格',
        closeStylePicker: '关闭风格选择',
      },
      graphStyleSwitchFailed: '切换图谱风格失败，已恢复原风格',
      showArrows: '显示箭头',
      hideArrows: '隐藏箭头',
  ...
  input: {
    ...
    placeholder: '随心输入',
    placeholderWithContext: '随心输入',
    placeholderWebOnly: '随心输入',
    placeholderKbAndWeb: '随心输入',
    placeholderAgent: '随心输入',
    agentMode: '智能推理',
    normalMode: '快速问答',
  ...
  settings: {
    ...
    storage: {
      ...
      configurable: '可配置',
      pathPrefix: '路径前缀（可选）',
      pathPrefixPlaceholder: '如 musuw/images',
      prefixPlaceholder: '如 musuw',
    ...
    weknoraCloud: {
      ...
      modelsSection: {
        title: '云模型接入',
        descReady: '将 Musuw Cloud 提供的四类标准模型注册到当前空间，用于对话、向量检索、重排序与多模态理解。',
  ...
  uploadConfirm: {
    ...
    videoCapability: '视频解析，最大 300 MB',
    videoTooLarge: '视频超过 300 MB，当前版本暂不支持',
    videoUploadFailed: '视频上传失败，请稍后重试',
    videoFormatUnsupported: '暂不支持此视频格式',
    urlItemLabel: 'URL',
    urlAdded: '已添加 URL',
  ...
  knowledgeBase: {
    ...
    uploadProgress: {
      title: '上传进度',
      summary: '共 {total} 个 · 已提交 {uploaded} 个 · 失败 {failed} 个 · 剩余 {remaining} 个',
      current: '正在上传：{name}（{progress}%）',
      keepOpen: '请保持页面打开。已提交的文档会自动显示解析状态，无需刷新。',
      finished: '上传已结束，文档解析状态会自动更新。失败文件请查看原因后重新上传。',
      details: '查看文件明细',
      waiting: '等待上传',
      uploading: '正在上传',
      success: '已提交解析',
    ...
    importURL: '导入网页',
    addDocument: '添加文档',
    importURLTitle: '导入链接或分享内容',
    urlRequired: '请输入链接或分享内容',
    ...
    batchCancelParseConfirm: '停止选中的 {count} 个解析任务？已完成的文档不受影响。',
    batchCancelParseSuccess: '已提交停止 {count} 个文档的解析',
    batchCancelParsePartial: '已提交停止 {success} 个，{failed} 个停止失败，可重试',
    draft: '草稿',
    draftTip: '暂存内容，未参与检索',
    untitledDocument: '未命名文档',
