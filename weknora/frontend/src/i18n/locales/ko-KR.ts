export default {
  ...
  entitlement: {
    ...
    recoveryPlanAction: '{plan}(으)로 복구',
    ...
    recoveryCheckoutNotice: '이전 Paddle 구독을 확인할 수 없습니다. 현재 또는 상위 요금제를 선택해 결제 연결을 안전하게 복구하세요.',
    ...
    recoveryCheckoutTitle: 'Paddle로 결제 연결 복구',
    recoveryCheckoutDescription: '이전 결제 연결을 확인할 수 없습니다. Paddle 보안 결제로 요금제를 복구하세요. 서명된 결제 이벤트를 확인한 후에만 접근 권한이 변경됩니다.',
