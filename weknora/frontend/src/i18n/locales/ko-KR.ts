...
export default {
  ...
  integrations: {
    ...
    claw: {
      title: 'Musuw Skill',
      subtitle: 'Musuw REST API로 문서를 가져오고 하이브리드 검색(벡터+키워드)을 수행합니다. 파일/URL/Markdown 업로드 및 검색에 사용.',
      ...
      ecosystemNote: 'Skill은 ClawHub에 호스팅됩니다. 전체 API 문서는 ClawHub 페이지를 참고하세요.',
      installCta: 'ClawHub 열기',
      installCtaHint: 'Musuw Skill 설치 · 새 탭에서 열림',
    ...
    chrome: {
      title: '지식 관리 어시스턴트',
      subtitle: '자체 호스팅 Musuw와 함께: 사이드바에서 질문하고, 웹 페이지를 클리핑하며, Markdown 메모를 지식베이스에 저장하세요.',
      ...
      steps: {
        ...
        port: {
          title: '데스크톱: 고정 포트(권장)',
          desc: 'Musuw 데스크톱에서는 API 정보에서 고정 포트(예: 37841)를 설정하세요.'
        },
        api: {
          title: 'API 자격 증명',
    ...
    api: {
      ...
      capabilityManageModelsHint: '모델 설정, 자격 증명, 연결 테스트 및 Musuw Cloud 자격 증명을 관리합니다.',
      ...
      signedFlowDetail: 'HMAC secret은 Musuw와 신뢰할 수 있는 백엔드에만 보관하세요. 요청에 넣거나 브라우저에 배포하지 마세요. 요청 헤더에는 secret이 아니라 해당 secret으로 서명한 JWT 문자열을 넣습니다(발급마다 또는 만료 후 변경). JWT에는 sub(외부 사용자 ID), tenant_id, aud=weknora, exp(최대 24시간)가 필요합니다.',
      ...
      hmacSecretDesc: 'Musuw에 저장된 것과 동일한 secret. 백엔드에서 JWT 서명에만 사용하며 요청 헤더로 보내지 않습니다.',
  ...
  mcpSettings: {
    ...
    empty: 'MCP 서비스 없음',
    noDescription: '설명 없음',
    enableHint: '서비스를 활성화하려면 클릭하세요',
    disableHint: '서비스를 비활성화하려면 클릭하세요',
  ...
  entitlement: {
    ...
    freeUrlImport: '링크 가져오기는 유료 요금제에서 사용할 수 있습니다.',
    storageQuotaUpgradeBody: '저장 공간이 가득 찼습니다. 파일을 계속 업로드하려면 요금제를 업그레이드하세요.',
    upgradeRequiredTitle: '계속하려면 요금제를 업그레이드하세요',
    notNow: '나중에',
    urlImportUpgradeBody: '웹 페이지 및 소셜 비디오 링크 가져오기는 유료 요금제에서 사용할 수 있습니다. 입력한 링크는 유지됩니다.',
    videoUploadUpgradeBody: '비디오 업로드는 유료 요금제에서 사용할 수 있습니다. 업그레이드하여 계속하세요.',
    videoMixedUpgradeBody: '일반 파일 {allowed}개는 계속 업로드됩니다. 비디오 {blocked}개를 업로드하려면 요금제를 업그레이드하세요.',
    advancedModelUpgradeBody: '이 고급 모델은 유료 요금제에서 사용할 수 있습니다. 업그레이드하여 선택하세요.',
    renewsMonthly: '크레딧 기간 {month} (UTC)',
    billingUnavailable: '결제가 구성될 때까지 업그레이드할 수 없습니다.',
    choosePlan: '요금제 선택',
    monthly: '월간',
    yearly: '연간',
    continueToCheckout: '안전한 결제로 이동',
    checkoutSecureNote: '안전한 결제 페이지에 지역별 최종 가격, 세금, 결제 수단이 표시됩니다. 결제 확인 후에만 요금제가 변경됩니다.',
    checkoutCompleted: '결제가 완료되었습니다. 요금제를 동기화하고 있습니다.',
    checkoutFailed: '안전한 결제 페이지를 열 수 없습니다. 다시 시도해 주세요.',
    billingManaged: '결제 및 구독은 결제 시스템에서 안전하게 관리됩니다.',
    manageBilling: '결제 관리',
    ...
    recommended: '추천',
    includes: '포함 사항',
    currentPlanAction: '현재 요금제',
    includedInCurrent: '현재 요금제에 포함됨',
    choosePlanAction: '{plan} 선택',
    featureStorage: '{amount} GB 저장 공간',
    featureAllowance: '{level} AI 사용 한도',
    featureFreeKnowledge: '지식 베이스 1개, 문서 최대 10개',
    featureBudgetModel: 'Free 전용 모델',
    featureUnlimitedKnowledge: '지식 베이스와 문서에 요금제 제한 없음',
    featureAllModels: '사용 가능한 모든 모델',
    ...
    included: '포함됨',
    notIncluded: '포함되지 않음',
    choosePeriod: '결제 주기 선택',
    upgradePlan: '요금제 업그레이드',
    upgradeDescription: '요금제와 결제 주기를 선택해 계속하세요.',
    upgradePaidDescription: '현재 결제 주기는 유지되며 남은 기간의 차액은 결제 시스템이 계산합니다.',
    upgradeTo: '{plan}(으)로 업그레이드',
    upgradeConfirmTitle: '{plan}(으)로 업그레이드',
    upgradeConfirmBody: '이번 변경 금액은 {amount}입니다. 확인하면 현재 결제 수단으로 결제되며 결제 확인 후 요금제와 한도가 자동으로 갱신됩니다.',
    upgradeConfirm: '업그레이드 확인',
    upgradePending: '업그레이드가 제출되었습니다. 요금제와 한도를 동기화하고 있습니다.',
    ...
    checkoutUnavailable: '이 요금제는 현재 사용할 수 없습니다. 나중에 다시 시도하세요.',
    portalUnavailable: '현재 요금제를 관리할 수 없습니다. 나중에 다시 시도하세요.',
    usageUnavailable: '현재 사용량 정보를 불러올 수 없습니다.',
    viewPlans: '요금제 보기',
    backToProduct: 'Musuw로 돌아가기',
    backToPlans: '요금제로 돌아가기',
    checkoutTitle: '요금제 구성',
    quickPayment: '간편 결제',
    ...
    checkoutSyncDelayedTitle: '결제가 접수되었으며 권한은 아직 동기화 중입니다',
    checkoutSyncDelayedDescription: '안전하게 Musuw로 돌아가거나 상태를 새로 고쳐 확인할 수 있습니다.',
    refreshStatus: '상태 새로 고침',
    returnToProduct: 'Musuw로 돌아가기',
    paymentLinkTitle: 'Paddle 보안 결제',
    paymentLinkReady: 'Paddle 영수증 또는 이메일의 결제 링크를 사용하세요. 보안 결제가 이 페이지에서 자동으로 열립니다.',
    paymentLinkError: '보안 결제 페이지를 사용할 수 없습니다. musuw로 돌아가거나 지원팀에 문의하세요.',
    paymentLinkSupport: '지원 문의',
    paymentLinkLegal: '결제 및 법률 정보',
  ...
  model: {
    ...
    editor: {
      ...
      providers: {
        ...
        gemini: {
          label: 'Google Gemini',
          description: 'gemini-3.8-flash, gemini-3.5-flash-lite 등'
        },
        mimo: {
          label: 'MiMo',
        ...
        deepseek: {
          label: 'DeepSeek',
          description: 'deepseek-flash, deepseek-v4-pro 등'
        },
        volcengine: {
          label: 'Volcengine',
        ...
        openrouter: {
          label: 'OpenRouter',
          description: 'deepseek/deepseek-v4.1-flash, google/gemini-3.8-flash 등'
        },
        zhipu: {
      ...
      modelNamePlaceholder: {
        ...
        remote: '예: gpt-5.4-nano, deepseek-flash',
        localVllm: '예: llava:latest',
        remoteVllm: '예: gpt-5.4-nano',
  ...
  system: {
    ...
    retry: '재시도',
    versionLabel: '앱 버전',
    versionDescription: 'Musuw 애플리케이션 서비스의 버전 번호',
    frontendVersionLabel: 'UI 버전',
    frontendVersionDescription: 'Musuw UI 빌드 버전 번호',
  ...
  chat: {
    ...
    aiCreditsExhausted: '이번 달 AI 사용 한도를 모두 사용했습니다. 지금 업그레이드하거나 다음 갱신을 기다려 주세요.',
    billingRenewalPending: '결제 확인이 아직 완료되지 않았거나 복구가 필요합니다.',
  ...
  knowledgeEditor: {
    ...
    titleEdit: '지식베이스 구성 편집',
    modalDescription: '지식베이스 처리 파이프라인, 인덱싱 전략 및 추출 매개변수 설정',
    advanced: {
      title: '고급 설정',
    ...
    wikiBrowser: {
      ...
      graphStyleToggle: '그래프 스타일 전환',
      graphVisualStyle: '시각 스타일',
      graphStyles: {
        obsidianExact: { name: 'Obsidian 완전 네이티브', desc: '원본 WASM 포스, Pixi 캔버스와 전체 설정' },
        weknoraNative: { name: 'WeKnora 네이티브', desc: '원본 저장소 SVG 그래프, 포스 레이아웃 및 상호작용' },
        threeNebula: { name: 'Obsidian 3D 성운', desc: '실제 3D 구체, 광채 및 자동 회전' },
        sigmaNebula: { name: '동적 성운', desc: '3D 회전과 호흡하는 성단' },
        sigmaForce: { name: '중력장', desc: 'ForceAtlas 관계 집약' },
        sigmaCircle: { name: '클래식 원형', desc: 'Graphology 공식 원형 레이아웃' },
        sigmaOrbit: { name: '은하 궤도', desc: '다층 궤도 분포' },
        sigmaClusters: { name: '커뮤니티 성단', desc: '페이지 유형별 군집' },
        g6Obsidian: { name: 'G6 Obsidian', desc: 'G6로 재현한 Graph View 힘 설정' },
        g6Force: { name: '힘 방향', desc: '관계를 자연스럽게 전개' },
        g6ForceAtlas2: { name: '커뮤니티 중력', desc: 'G6 내장 ForceAtlas2' },
        g6Fruchterman: { name: '클러스터 힘장', desc: 'G6 내장 군집 힘 레이아웃' },
        g6Mds: { name: 'MDS 맵', desc: 'G6 내장 관계 거리 맵' },
        g6Radial: { name: '방사형', desc: '중심에서 바깥으로 확장' },
        g6Concentric: { name: '동심 계층', desc: '연결이 많은 노드를 중심에 배치' },
        g6Circular: { name: '원형 별궤적', desc: '나선형 계층 배치' },
        g6Grid: { name: '매트릭스', desc: '규칙적인 그리드 개요' },
      },
      obsidianGraph: {
        filters: '필터',
        search: '검색',
        ...
        groupQuery: '그룹 쿼리',
        groupColor: '그룹 색상',
        queryPlaceholder: '쿼리 입력',
        newGroup: '새 그룹',
        deleteGroup: '그룹 삭제',
        display: '표시',
        arrows: '화살표',
        textFade: '텍스트 페이드 임계값',
        nodeSize: '노드 크기',
        linkThickness: '링크 두께',
        animate: '다시 애니메이션',
        playbackTitle: '관계 그래프 재생',
        playbackDescription: 'Obsidian 보정 타임라인에 따라 그래프 노드를 단계적으로 표시합니다.',
        playbackPlay: '성장 애니메이션 재생',
        playbackPause: '성장 애니메이션 일시정지',
        playbackResume: '성장 애니메이션 계속',
        playbackReplay: '성장 애니메이션 다시 재생',
        playbackRestore: '원래대로 복원',
        playbackProgress: '{visible} / {total}개 노드',
        forces: '포스',
        center: '중앙 포스',
        repel: '반발 포스',
        link: '링크 포스',
        ...
        closeStylePicker: '스타일 선택 닫기',
      },
      graphStyleSwitchFailed: '그래프 스타일을 전환하지 못해 이전 스타일로 복원했습니다.',
      showArrows: '화살표 표시',
      hideArrows: '화살표 숨기기',
  ...
  knowledgeList: {
    ...
    empty: {
      title: '지식베이스 없음',
      description: '페이지의 「지식베이스 생성」 버튼을 눌러 첫 번째 지식베이스를 만드세요',
  ...
  createChat: {
    title: '안녕하세요, Musuw입니다 — 당신의 지식을 손끝에',
  ...
  input: {
    ...
    back: '뒤로',
    noReasoningEfforts: '사용 가능한 추론 단계가 없습니다',
    searchModels: '모델 검색',
    clearModelSearch: '모델 검색 지우기',
    reasoningDescriptions: {
      none: '일상적인 질문에 더 빠르게 응답',
      minimal: '빠른 응답을 위한 가벼운 추론',
      low: '속도와 추론의 균형',
      medium: '복잡한 작업을 위한 표준 추론',
      high: '더 깊은 다단계 분석',
      xhigh: '어려운 작업을 위한 확장 추론',
      max: '가장 깊은 추론, 더 오래 걸림'
    },
  ...
  auth: {
    ...
    registerSubtitle: '계정을 만들고 Musuw를 시작하세요',
    ...
    workspaceOnboarding: {
      liteTitle: 'Musuw를 준비하고 있습니다',
      liteDescription: '계정마다 개인 공간 하나가 제공되므로 작업 공간을 만들거나 참여할 필요가 없습니다.',
      liteLoading: '개인 공간을 준비하고 있습니다…',
      liteLoadFailed: '개인 공간을 준비하지 못했습니다. 네트워크를 확인한 뒤 다시 시도하세요.',
      liteWaiting: '개인 공간을 아직 준비 중입니다. 잠시 후 다시 확인하세요.',
      title: '작업 공간 선택',
  ...
  settings: {
    ...
    storage: {
      ...
      pathPrefixPlaceholder: '예: musuw/images',
      prefixPlaceholder: '예: musuw',
    ...
    weknoraCloud: {
      ...
      modelsSection: {
        title: '클라우드 모델',
        descReady: 'Musuw Cloud의 네 가지 표준 모델을 등록하여 대화, 검색, 재정렬, 비전에 사용합니다.',
  ...
  agent: {
    ...
    editor: {
      ...
      promptsConfig: '프롬프트',
      promptsConfigDesc: '에이전트 시스템 프롬프트 구성',
      modelConfig: '모델 구성',
  ...
  uploadConfirm: {
    ...
    videoCapability: '동영상 파싱, 최대 300MB',
    videoTooLarge: '300MB를 초과하는 동영상은 현재 버전에서 지원되지 않습니다',
    videoUploadFailed: '동영상 업로드에 실패했습니다. 잠시 후 다시 시도하세요.',
    videoFormatUnsupported: '이 동영상 형식은 지원되지 않습니다',
    urlItemLabel: 'URL',
  ...
  knowledgeBase: {
    ...
    uploadProgress: {
      title: '업로드 진행 상황',
      summary: '총 {total}개 · 제출 {uploaded}개 · 실패 {failed}개 · 남음 {remaining}개',
      current: '업로드 중: {name} ({progress}%)',
      keepOpen: '페이지를 열어 두세요. 제출된 문서의 처리 상태는 새로고침 없이 자동으로 표시됩니다.',
      finished: '업로드가 끝났습니다. 처리 상태는 자동으로 갱신됩니다. 실패한 파일은 원인을 확인한 후 다시 업로드하세요.',
      details: '파일 상세 보기',
      waiting: '업로드 대기 중',
      uploading: '업로드 중',
      success: '처리 요청 완료',
    ...
    importURL: '웹페이지 가져오기',
    addDocument: '문서 추가',
    importURLTitle: 'URL 또는 공유 메시지 가져오기',
    urlRequired: 'URL 또는 공유 메시지를 입력하세요',
    ...
    batchCancelParseConfirm: '선택한 문서 {count}개의 파싱을 중지할까요? 완료된 문서는 영향을 받지 않습니다.',
    batchCancelParseSuccess: '문서 {count}개의 파싱 중지를 요청했습니다',
    batchCancelParsePartial: '{success}개 중지 요청 완료, {failed}개 실패. 다시 시도할 수 있습니다',
    draft: '초안',
  ...
  contextualGuide: {
    ...
    agentCreate: {
      steps: {
        submitLite: {
          title: '에이전트 만들기',
          desc: '이름, 모델, 지식 범위를 확인한 뒤 강조된 「만들기」 버튼을 누르세요.'
        },
        knowledgeLite: {
          title: '지식 범위 선택',
          desc: '모든 지식 베이스를 사용하거나 특정 항목만 선택할 수 있으며, 지금은 연결하지 않아도 됩니다.'
        },
        modelLite: {
          title: '모델 선택',
          desc: '현재 요금제에서 사용할 수 있는 모델을 선택하세요. 잠긴 고급 모델은 업그레이드 필요 여부를 명확히 안내합니다.'
        },
        nameLite: {
          title: '에이전트 이름 정하기',
          desc: '알아보기 쉬운 이름을 입력하세요. 설명은 나중에 추가하거나 수정할 수 있습니다.'
        },
        modeLite: {
          title: '답변 방식 선택',
          desc: '빠른 답변은 직접적인 질문에, 스마트 추론은 여러 단계가 필요한 복잡한 작업에 적합합니다.'
        },
        submit: {
          title: '에이전트 저장',
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      agentsLite: {
        title: '알맞은 에이전트 선택',
        desc: '빠른 답변은 일상 질문에, 스마트 추론은 복잡한 작업에 적합합니다. 필요할 때만 나만의 에이전트를 만드세요.'
      },
      settingsLite: {
        title: '계정 및 설정 보기',
        desc: '이 메뉴에서 계정, 사용량, 화면 설정을 확인할 수 있습니다.'
      },
      chatLite: {
        title: '대화부터 시작하기',
        desc: '질문을 입력하거나 이미지 또는 파일을 추가하세요. 고급 모델이나 유료 기능이 필요하면 Musuw가 명확히 설명하고 업그레이드를 안내합니다.'
      },
      welcomeLite: {
        title: 'Musuw에 오신 것을 환영합니다',
        desc: '개인 공간과 사용 가능한 모델이 이미 준비되어 있어 별도 설정 없이 시작할 수 있습니다. 자주 쓰는 세 가지 입구만 살펴보세요.'
      },
      done: {
        title: '준비 완료',
