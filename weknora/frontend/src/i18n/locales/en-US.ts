export default {
  ...
  entitlement: {
    ...
    featureFreeKnowledge: '1 knowledge base with up to 10 documents',
    featureBudgetModel: 'One least-cost model per capability',
    featureUnlimitedKnowledge: 'No plan cap on knowledge bases or documents',
    featureAllModels: 'Expanded platform-approved catalog',
