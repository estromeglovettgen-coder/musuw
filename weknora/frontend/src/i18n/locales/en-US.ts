export default {
  ...
  entitlement: {
    ...
    recoveryPlanAction: 'Restore with {plan}',
    ...
    recoveryCheckoutNotice: 'Your previous Paddle subscription could not be verified. Choose your current or a higher plan to restore billing securely.',
    ...
    recoveryCheckoutTitle: 'Restore billing with Paddle',
    recoveryCheckoutDescription: 'Your previous billing link could not be verified. Use Paddle secure checkout to restore this plan; access changes only after signed payment events are verified.',
