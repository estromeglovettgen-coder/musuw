...
export default {
  ...
  knowledgeBase: {
    ...
    uploadProgress: {
      ...
      summary: '{total} files · {uploaded} submitted · {failed} failed · {remaining} remaining',
      current: 'Uploading: {name} ({progress}%)',
      keepOpen: 'Keep this page open. Submitted documents show their processing status automatically; no refresh is needed.',
      finished: 'Upload finished. Processing status updates automatically. Review failed files before uploading them again.',
      details: 'View file details',
      waiting: 'Waiting to upload',
      uploading: 'Uploading',
      success: 'Submitted for processing',
      error: 'Upload failed',
    },
    ...
    batchCancelParseConfirm: 'Stop parsing the {count} selected active documents? Completed documents are unaffected.',
    batchCancelParseSuccess: 'Requested parsing stop for {count} documents',
    batchCancelParsePartial: 'Requested stop for {success}; {failed} failed and can be retried',
    draft: 'Draft',
  ...
  uploadConfirm: {
    ...
    videoCapability: 'Video parsing, up to 300 MB',
    videoTooLarge: 'Videos over 300 MB are not supported in this version',
    videoUploadFailed: 'Video upload failed. Please try again later.',
    videoFormatUnsupported: 'This video format is not supported',
    urlItemLabel: 'URL',
    urlAdded: 'URL added',
  ...
  settings: {
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. musuw/images',
      prefixPlaceholder: 'e.g. musuw',
  ...
  input: {
    ...
    back: 'Back',
    noReasoningEfforts: 'No reasoning levels available',
    searchModels: 'Search models',
    clearModelSearch: 'Clear model search',
    reasoningDescriptions: {
      none: 'Faster for everyday questions',
      minimal: 'Light reasoning for quick responses',
      low: 'Balances speed and reasoning',
      medium: 'Standard reasoning for complex tasks',
      high: 'Deeper multi-step analysis',
      xhigh: 'Extended reasoning for hard tasks',
      max: 'Deepest reasoning, takes longer'
    },
    placeholder: 'Do anything',
    placeholderWithContext: 'Do anything',
    placeholderWebOnly: 'Do anything',
    placeholderKbAndWeb: 'Do anything',
    placeholderAgent: 'Do anything',
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      graphStyleToggle: 'Switch graph style',
      graphVisualStyle: 'Visual style',
      graphStyles: {
        obsidianExact: { name: 'Obsidian exact', desc: 'Original WASM forces, Pixi canvas and complete controls' },
        weknoraNative: { name: 'WeKnora native', desc: 'Original repository SVG graph, force layout and interactions' },
        threeNebula: { name: 'Obsidian 3D nebula', desc: 'True 3D shell, glow and auto-orbit' },
        sigmaNebula: { name: 'Living nebula', desc: '3D rotation and breathing clusters' },
        sigmaForce: { name: 'Gravity', desc: 'ForceAtlas relationship field' },
        sigmaCircle: { name: 'Classic circle', desc: 'Official Graphology circular layout' },
        sigmaOrbit: { name: 'Galaxy orbit', desc: 'Layered orbital distribution' },
        sigmaClusters: { name: 'Communities', desc: 'Clusters by page type' },
        g6Obsidian: { name: 'G6 Obsidian', desc: 'Graph View forces rendered by G6' },
        g6Force: { name: 'Force field', desc: 'Relationships expand naturally' },
        g6ForceAtlas2: { name: 'Community gravity', desc: 'Built-in G6 ForceAtlas2' },
        g6Fruchterman: { name: 'Cluster field', desc: 'Built-in clustered force layout' },
        g6Mds: { name: 'MDS map', desc: 'Built-in relationship distance map' },
        g6Radial: { name: 'Radial bloom', desc: 'Radiates from a central node' },
        g6Concentric: { name: 'Concentric', desc: 'Connected nodes stay central' },
        g6Circular: { name: 'Star trails', desc: 'Spiral layered arrangement' },
        g6Grid: { name: 'Matrix', desc: 'Regular overview grid' },
      },
      obsidianGraph: {
        filters: 'Filters',
        search: 'Search',
        ...
        tags: 'Tags',
        attachments: 'Attachments',
        existingOnly: 'Existing files only',
        orphans: 'Orphans',
        groups: 'Groups',
        ...
        animate: 'Animate',
        playbackTitle: 'Growth playback',
        playbackDescription: 'Reveal the graph progressively using the Obsidian-calibrated timeline.',
        playbackPlay: 'Play growth animation',
        playbackPause: 'Pause growth animation',
        playbackResume: 'Resume growth animation',
        playbackReplay: 'Replay growth animation',
        playbackRestore: 'Restore original',
        playbackProgress: '{visible} / {total} nodes',
        forces: 'Forces',
        center: 'Center force',
        repel: 'Repel force',
        link: 'Link force',
        ...
        closeStylePicker: 'Close style picker',
      },
      graphStyleSwitchFailed: 'Could not switch graph style. The previous style was restored.',
  ...
  chat: {
    ...
    aiCreditsExhausted: 'Your monthly AI allowance is used up. Upgrade for more now, or wait for the next reset.',
    billingRenewalPending: 'Billing confirmation is pending or needs repair.',
  ...
  system: {
    ...
    versionDescription: 'Version of the Musuw application service',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the Musuw UI',
  ...
  entitlement: {
    ...
    active: 'active',
    storage: 'Storage',
    monthlyCredits: 'Monthly AI allowance',
    knowledgeBases: 'Knowledge bases',
    ...
    freeUrlImport: 'Link import is available on paid plans.',
    storageQuotaUpgradeBody: 'Storage is full. Upgrade your plan to continue uploading files.',
    upgradeRequiredTitle: 'Upgrade to continue',
    notNow: 'Not now',
    urlImportUpgradeBody: 'Link import, including web pages and social videos, is available on paid plans. Your link has been preserved.',
    videoUploadUpgradeBody: 'Video upload is available on paid plans. Upgrade to continue.',
    videoMixedUpgradeBody: '{allowed} regular files are uploading. Upgrade to upload the other {blocked} video files.',
    advancedModelUpgradeBody: 'This advanced model is available on paid plans. Upgrade to select it.',
    renewsMonthly: 'Credit period {month} (UTC)',
    billingUnavailable: 'Upgrades are unavailable until billing is configured.',
    choosePlan: 'Choose a plan',
    monthly: 'Monthly',
    yearly: 'Yearly',
    continueToCheckout: 'Continue to secure checkout',
    checkoutSecureNote: 'The secure payment page shows the final regional price, tax, and available payment methods. Your plan changes only after payment is confirmed.',
    checkoutCompleted: 'Payment completed. Your plan is syncing.',
    checkoutFailed: 'The secure payment page could not be opened. Please try again.',
    billingManaged: 'Billing and subscriptions are securely managed by the payment system.',
    ...
    planDescriptions: { free: 'Explore the full workflow', plus: 'For a growing knowledge base', pro: 'For daily knowledge work', max: 'For intensive knowledge work' },
    ...
    featureStorage: '{amount} GiB storage',
    featureAllowance: '{level} monthly AI credit allowance',
    featureFreeKnowledge: '1 knowledge base (10 docs)',
    featureBudgetModel: 'Standard models',
    featureUnlimitedKnowledge: 'Unlimited knowledge bases',
    featureAllModels: 'Advanced models',
    featureVideo: 'Video & link import',
    ...
    checkoutUnavailable: 'This plan is not available right now. Please try again later.',
    portalUnavailable: 'Plan management is currently unavailable. Please try again later.',
    usageUnavailable: 'Usage details are currently unavailable.',
    viewPlans: 'View plans',
    backToProduct: 'Back to Musuw',
    backToPlans: 'Back to plans',
    checkoutTitle: 'Configure plan',
    ...
    checkoutSyncDelayedTitle: 'Payment received; synchronization is still pending',
    checkoutSyncDelayedDescription: 'Your entitlement is still syncing. You can safely return to Musuw or refresh the status.',
    refreshStatus: 'Refresh status',
    returnToProduct: 'Return to Musuw',
    paymentLinkTitle: 'Secure Paddle payment',
    paymentLinkReady: 'Use the Paddle payment link from your receipt or email. Its secure checkout opens automatically on this page.',
    paymentLinkError: 'The secure payment page is unavailable. Return to musuw or contact support.',
    paymentLinkSupport: 'Contact support',
    paymentLinkLegal: 'Payment and legal information',
  ...
  integrations: {
    ...
    api: {
      ...
      hmacSecretDesc: 'Same secret stored in Musuw; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted Musuw: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On Musuw Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      title: 'Musuw Skill',
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the Musuw REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
