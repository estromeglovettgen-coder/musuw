...
test('consumer plan copy states the enforced storage, allowance, and model catalog contract', () => {
  assert.match(en, /allowanceLevels:\s*\{\s*free: '\$0\.40', plus: '\$1\.25', pro: '\$2\.50', max: '\$5\.00'\s*\}/)
  ...
  assert.match(zh, /allowanceLevels:\s*\{\s*free: '\$0\.40', plus: '\$1\.25', pro: '\$2\.50', max: '\$5\.00'\s*\}/)
