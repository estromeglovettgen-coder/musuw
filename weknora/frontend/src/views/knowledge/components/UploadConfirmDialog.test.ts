...
const knowledgeBase = readFileSync(new URL('../KnowledgeBaseMechanical.vue', import.meta.url), 'utf8')
const app = readFileSync(new URL('../../../App.vue', import.meta.url), 'utf8')
const manualEditor = readFileSync(new URL('../../../components/manual-knowledge-editor.vue', import.meta.url), 'utf8')

test('mechanical knowledge detail keeps platform-default upload actions', () => {
