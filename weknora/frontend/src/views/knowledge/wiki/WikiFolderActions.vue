...
<style scoped>
.reference-wiki-folder-action{position:relative;display:inline-flex;flex:0 0 auto;font-family:"Inter Variable",Inter,"Noto Sans SC Variable","Noto Sans SC",ui-sans-serif,system-ui,sans-serif}.reference-wiki-folder-action__trigger{width:24px;height:24px;padding:0;border:0;border-radius:7px;background:transparent;color:#9ca3af;display:grid;place-items:center;opacity:0;cursor:pointer}.reference-wiki-folder-action:hover .reference-wiki-folder-action__trigger,.reference-wiki-folder-action__trigger.open{opacity:1}.reference-wiki-folder-action__trigger:hover{background:#f3f4f6;color:#374151}.reference-wiki-folder-action__backdrop{position:fixed;inset:0;z-index:130}.reference-wiki-folder-action__popup{position:absolute;top:calc(100% + 5px);right:0;z-index:140;width:190px;padding:6px;border:1px solid #e5e7eb;border-radius:12px;background:#fff;box-shadow:0 20px 25px -5px rgb(0 0 0 / 10%),0 8px 10px -6px rgb(0 0 0 / 10%);color:#374151}.reference-wiki-folder-action__popup>button{width:100%;min-height:31px;padding:0 9px;border:0;border-radius:8px;background:transparent;color:#4b5563;display:flex;align-items:center;gap:8px;font:600 10px/14px inherit;text-align:left;cursor:pointer}.reference-wiki-folder-action__popup>button:hover{background:#f3f4f6;color:#111827}.reference-wiki-folder-action__popup>button.danger{color:#dc2626}.reference-wiki-folder-action__divider{height:1px;margin:5px 2px;background:#f3f4f6}.reference-wiki-folder-action__popup>strong{display:block;margin:3px 3px 8px;color:#111827;font-size:10px;line-height:14px}.reference-wiki-folder-action__popup>p{margin:0 3px 10px;color:#6b7280;font-size:9px;line-height:14px}.reference-wiki-folder-action__popup>input{width:100%;height:32px;box-sizing:border-box;padding:0 9px;border:1px solid #e5e7eb;border-radius:9px;outline:0;color:#111827;font:500 10px/1.4 inherit}.reference-wiki-folder-action__popup>input:focus{border-color:#9ca3af;box-shadow:0 0 0 3px rgb(17 24 39 / 5%)}.reference-wiki-folder-action__actions{display:flex;justify-content:flex-end;gap:6px;margin-top:10px}.reference-wiki-folder-action__actions button{height:29px;padding:0 10px;border-radius:8px;font:700 9px/13px inherit;cursor:pointer}.reference-wiki-folder-action__actions .secondary{border:1px solid #e5e7eb;background:#fff;color:#6b7280}.reference-wiki-folder-action__actions .primary{border:1px solid #111827;background:#111827;color:#fff}.reference-wiki-folder-action__actions .primary:disabled{opacity:.4;cursor:not-allowed}.reference-wiki-folder-action__actions .danger-solid{border:1px solid #dc2626;background:#dc2626;color:#fff}
</style>
