...
.action-badge {
  ...
  &.created {
    color: var(--td-success-color);
    background: var(--td-success-color-light);
    border: 1px solid color-mix(in srgb, var(--td-success-color) 22%, var(--td-component-stroke));
  }
  &.updated {
    color: var(--td-brand-color);
    background: var(--td-brand-color-light);
  ...
  &.deleted {
    color: var(--td-error-color);
    background: var(--td-error-color-light);
    border: 1px solid color-mix(in srgb, var(--td-error-color) 22%, var(--td-component-stroke));
  }
}
