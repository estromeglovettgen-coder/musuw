<template>
  <div class="login-layout">
    ...
    <div class="header-links">
      <a href="https://musuw.com" target="_blank" class="header-link" :title="$t('common.website')">
      ...
      <a href="https://github.com/estromeglovettgen-coder/musuw" target="_blank" class="header-link" :title="$t('common.info')">
...
import { persistLocalePreference } from '@/i18n/locale'
...
const selectLanguage = (lang: string) => {
  const persisted = persistLocalePreference(lang)
  if (!persisted) return
...
.login-layout {
  ...
  overflow: hidden;
  position: relative;
  /* Keep the showcase legible without the saturated green hero treatment. */
  background: #243447;
...
.register-cta {
  ...
  &__button {
    ...
    &:hover {
      border-color: var(--musuw-accent-hover);
      color: var(--musuw-accent-hover);
      background: var(--musuw-accent-soft);
    }
  }
}
...
html[theme-mode="dark"] {
  ...
  .form-content .t-input {
    ...
    &:hover {
      border-color: var(--musuw-accent) !important;
    }
