...
// Preserve the original WeKnora state contract: the externally supplied model
// list is filtered only when that list changes. UI-only search below filters the
// already-resolved list and does not alter model selection state.
