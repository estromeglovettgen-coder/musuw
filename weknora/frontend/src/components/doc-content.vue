...
/* Document images are content, not status indicators. Keep their treatment
   quiet and neutral instead of inheriting the old green visual skin. */
:deep(.md-content img),
:deep(.doc-markdown-root img.markdown-image) {
