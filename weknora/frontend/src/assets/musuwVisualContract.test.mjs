...
test("uses the archived Musuw typefaces and neutral visual tokens", () => {
  ...
  assert.match(theme, /--musuw-ink:\s*#262626/);
  assert.match(theme, /--musuw-muted:\s*#5d5d5d/);
  assert.match(theme, /--musuw-line:\s*#e7e7e7/);
  assert.match(theme, /--musuw-line-strong:\s*#c7c7c7/);
  assert.match(theme, /--musuw-accent:\s*#0b57d0/);
