...
const controllers = [
  ...
  },
  {
    ...
    bindings: [
      'authStore', 'handleCreateKnowledgeBase', 'uploadSummaries', 'loading', 'kbs', 'sortedMineKbs',
      'toggleKbSection', 'mineKbSectionCounts', 'isKbSectionCollapsed', 'isMyKb', 'showShareGroupHeaders',
      'kbSectionOf', 'highlightedKbId', 'highlightedCardRef', 'handleCardClick', 'isKbFavorited',
      'toggleFavoriteKb', 'isWikiKb', 'handleTogglePin', 'canDuplicateKBCard', 'handleDuplicate',
      'canManageKBCard', 'handleDelete',
    ],
  },
  {
