...
func TestTenantInfrastructureRoutesDeclareSpecificCapabilities(t *testing.T) {
	...
	cases := []struct {
		...
		{http.MethodGet, "/api/v1/models/scene-options/:scene", types.APIKeyCapabilityManageModels},
		...
		{http.MethodPost, "/api/v1/agents/:id/embed-channels", types.APIKeyCapabilityManageChannels},
		{http.MethodGet, "/api/v1/agents/:id/embed-channels", types.APIKeyCapabilityManageChannels},
		{http.MethodGet, "/api/v1/embed-channels", types.APIKeyCapabilityManageChannels},
		{http.MethodGet, "/api/v1/embed-channels/:channel_id", types.APIKeyCapabilityManageChannels},
		{http.MethodPut, "/api/v1/embed-channels/:channel_id", types.APIKeyCapabilityManageChannels},
		{http.MethodDelete, "/api/v1/embed-channels/:channel_id", types.APIKeyCapabilityManageChannels},
		{http.MethodPost, "/api/v1/embed-channels/:channel_id/rotate-token", types.APIKeyCapabilityManageChannels},
		{http.MethodPost, "/api/v1/embed-channels/:channel_id/preview-session", types.APIKeyCapabilityManageChannels},
		{http.MethodGet, "/api/v1/embed-channels/:channel_id/stats", types.APIKeyCapabilityManageChannels},
		{http.MethodPost, "/api/v1/agents/:id/im-channels", types.APIKeyCapabilityManageChannels},
		{http.MethodGet, "/api/v1/agents/:id/im-channels", types.APIKeyCapabilityManageChannels},
		{http.MethodGet, "/api/v1/im-channels", types.APIKeyCapabilityManageChannels},
		{http.MethodPut, "/api/v1/im-channels/:id", types.APIKeyCapabilityManageChannels},
		{http.MethodDelete, "/api/v1/im-channels/:id", types.APIKeyCapabilityManageChannels},
		{http.MethodPost, "/api/v1/im-channels/:id/toggle", types.APIKeyCapabilityManageChannels},
		{http.MethodPost, "/api/v1/wechat/qrcode", types.APIKeyCapabilityManageChannels},
		{http.MethodPost, "/api/v1/wechat/qrcode/status", types.APIKeyCapabilityManageChannels},
