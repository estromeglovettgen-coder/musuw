...
// PaddleBillingOperation is the durable record that bridges a local billing
// request and an external Paddle call. Result is opaque JSON owned by the
// caller; PaddleTransactionID is populated after creating/reusing a checkout
// transaction and is intentionally retained for timeout recovery.
