...
for key in \
    ...
    WEKNORA_STAGING_DOCREADER_TMP_VOLUME WEKNORA_STAGING_REDIS_VOLUME \
...
required_secrets=(db_password redis_password system_aes_key jwt_secret oidc_client_id oidc_client_secret supabase_service_role_key openrouter_management_api_key paddle_api_key paddle_webhook_secret r2_access_key_id r2_secret_access_key)
