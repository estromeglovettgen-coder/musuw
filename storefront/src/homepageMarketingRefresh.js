...
const MARKETING_COPY = Object.freeze({
  en: Object.freeze({
    ...
    meta: Object.freeze({
      title: "musuw | Turn scattered sources into working knowledge",
      description:
    ...
    hero: Object.freeze({
      ...
      titleLine1: "Turn scattered sources",
      titleLine2: "into knowledge that works.",
    ...
    pricing: Object.freeze({
      intro: Object.freeze({
        title: "Plans that scale with your knowledge.",
        body:
      ...
      features: Object.freeze([
        Object.freeze(["1 GiB storage", "Standard models", "Light AI usage", "Documents and web links"]),
        Object.freeze(["10 GiB storage", "Advanced models", "Regular AI usage", "Video and social links"]),
        Object.freeze(["30 GiB storage", "Advanced models", "High AI usage", "Video and social links"]),
        Object.freeze(["100 GiB storage", "Advanced models", "Highest AI usage", "Video and social links"]),
      ]),
    ...
    comparison: Object.freeze({
      eyebrow: "Plan differences",
      title: "Only the limits change.",
      description:
        "Every plan includes RAG answers, exact citations, an AI-organized Wiki, a knowledge graph, source history, export, and deletion controls.",
  ...
  zh: Object.freeze({
    ...
    pricing: Object.freeze({
      ...
      features: Object.freeze([
        Object.freeze(["1 GiB 存储空间", "标准模型", "轻量 AI 使用", "文档与网页链接"]),
        Object.freeze(["10 GiB 存储空间", "高级模型", "常规 AI 使用", "视频与社媒链接"]),
        Object.freeze(["30 GiB 存储空间", "高级模型", "高频 AI 使用", "视频与社媒链接"]),
        Object.freeze(["100 GiB 存储空间", "高级模型", "最高 AI 使用量", "视频与社媒链接"]),
      ]),
    ...
    comparison: Object.freeze({
      eyebrow: "套餐差异",
      title: "不同方案，只改变使用边界。",
      description: "所有方案都包含 RAG 问答、精确引用、AI Wiki、知识图谱、资料历史、导出与删除控制。",
