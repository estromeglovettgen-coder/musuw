  ...
  zh: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: "可以使用哪些模型？", answer: "Musuw 托管接入 30+ 主流模型；可用范围取决于套餐和产品目录" },
        { question: "我的内容会被用于训练模型吗？", answer: "Musuw 不拥有你的内容；数据处理取决于产品显示的服务商与模型，详见隐私政策" },
        { question: "达到套餐上限后会怎样？", answer: "已有知识仍可访问；你可以升级、删除内容，或在适用时等待额度重置" },
