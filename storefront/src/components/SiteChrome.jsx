...
const footerLabels = Object.freeze({
  en: Object.freeze([
    Object.freeze({ title: "Product", links: Object.freeze(["Features", "Platform", "Pricing", "Media kit", "Citation checks"]) }),
  ...
  zh: Object.freeze([
    Object.freeze({ title: "产品", links: Object.freeze(["功能", "平台", "定价", "媒体资料", "引用核验"]) }),
        ...
        {groups.map((group, groupIndex) => (
          <div className="footer-group" key={group.title}>
            ...
            {group.links.map(([label, href], linkIndex) => (
              <a href={href === CITATION_GUIDES.en.path && copy?.pricing?.currencyCode === "CNY" ? CITATION_GUIDES["zh-CN"].path : href} key={label}>
