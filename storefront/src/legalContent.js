    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          note("Personal and Pro purchases use Paddle Checkout after musuw sign-in. A checkout return is not proof of payment; musuw displays billing status only after its server verifies Paddle's signed notification.")
        ]
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          note("个人版和专业版在登录 musuw 后使用 Paddle 结账。返回结账页面不代表付款成功；仅在 musuw 服务器验证 Paddle 签名通知后，产品才显示账单状态。")
        ]
      },
      {
        heading: "4. 账户与安全",
